...
As seen from the image, each message is now a list of character sequences. All of the associated code can be found on my [GitHub](https://github.com/l0rdm0rd) but this is the small function was used for the preprocessing:
```python
