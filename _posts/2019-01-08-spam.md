...
<img src="L0rdM0rd.github.io/_posts/images/spam/token-text.png" alt="tokenized msg">

As seen from the image, each message is now a list of character sequences. All of the associated code can be found on my [GitHub](https://github.com/l0rdm0rd). This is the small function used for the preprocessing.
'''python
